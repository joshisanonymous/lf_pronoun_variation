\chapter{Subject Pronoun Variation in Louisiana French}
  ...
  \section{Social and structural constraints on French and Creole} % Each section begins with a brief acknowledgement that these factors CAN be significant in language variation in general
    ...
    \subsection{Socioeconomic class}
  \section{Methods}
