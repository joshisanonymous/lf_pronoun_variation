    ...
    \subsection{General distinguishing features of French and Creole}
      ...
      % Morphology
        ...
        % Verbs
          ...
          % ils agreement can be marked with -ont on the verb (Rottet 1995:201-202)
      % Prepositions
      ...
      % Ethnic variation
        ...
        % Morphology
          % In Terrebonne-Lafourche, Cajuns used preferred /e/ on verbs to make them agree with vous whereas Indians preferred NULL endings regardless of whether vous was used as a singular or plural pronoun (Rottet 1995:194/199)
