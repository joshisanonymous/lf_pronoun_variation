\chapter{Introduction}
  % What is Louisiana, as a whole, in the public imagination and why do we care
    % Objective: Examine how ethnicity and race are or are not expressed through the French and Creole as spoken in Louisiana
  ...
  Another major point of interest is the French and Creole (F\&C) spoken in South Louisiana as heritage languages whereas they were the dominant languages perhaps as recently as the mid 20th century.
  ...
  \section{Race and ethnicity}
    ...
    \subsection{Racially conditioned language variation}
      \label{sec:racial_language_variation}
    ...
    \subsection{Ethnically conditioned language variation}
      \label{sec:ethnic_language_variation}
    ...
    \subsection{French vs Creole}
      ...
      % Structural blurring of boundaries between French and Creole
        ...
        % Klingler (2003 "Language") uses 1sg subject pronouns, past perfective constructions, and the verb 'to have' as diagnostics for structurally disentangling French and Creole (80)
          ...
          % This diagnostic highlights the relevance (for Klingler and/or for speakers, it's not clear?) of subject pronoun forms for distinguishing different ways of speaking
        % There are other examples of structurally ambiguous language use, though
          % Disjunctive pronouns are sometimes used in place of object clitic pronouns (e.g., s'il a pu rencontrer elle) (Conwell & Juilland 1963, as cited in Rottet 1995:214)
    ...
    \subsection{General distinguishing features of French and Creole}
      ...
      % Morphology
        ...
        % Verbs
          ...
          % ils agreement can be marked with -ont on the verb both in present habitual and in the past imperfective with -iont (Rottet 1995:201-202)
            % This also leads to forms such as ils avont, ils allont, and ils faisont (Rottet 1995:202)
      % Prepositions
      ...
      % English influence
        % Two Cajun women (73 and 88) from Gonzales produced code-switching in an interview (B. Brown 1986:401)
          ...
          % Types: 54 emblematic vs 28 intimate, meaning most switches were single nouns, and 82 conversational vs 3 situational, meaning switches didn't involve changes in participants or subjects (403)
            % Thee emblematic switches often involve modern technologies (B. Brown 1986:400-401)
        % Lexical items
