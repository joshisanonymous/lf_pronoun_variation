\begin{frame}{Objectif\Logo}
  De mieux comoprendre la façon dont la race et l'ethnicité sont exprimées par les pronoms sujets en français louisianais, en concevant \alert{de manière générale} la langue
  \begin{enumerate}
