...
\documentclass{beamer}
  ...
  % Research questions
  \newcommand{\RQone}{
    Est-ce que le système racial binaire (Noir-Blanc) des É.-U. en général a été superposé sur les catégories ethniques de Louisiane jusqu'à ce qu'il est reproduit dans les pronoms sujets de la 3e personne au pluriel?
  }
